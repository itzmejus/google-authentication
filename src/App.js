      ...
      <body>
        <div class="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0">
          ...
          <div class="w-full lg:w-2/5">
            <img src={localStorage.getItem("profilePic")} class="rounded-none lg:rounded-lg shadow-2xl hidden lg:block" />
          </div>
        </div>
      </body>
    </div>
